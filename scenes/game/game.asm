...
MSG_LINE_CHAR_L0  = 4    ; Message Line — pierwszy znak po lewej (indeks 40)
MSG_LINE_CHAR_L1  = 8    ; Message Line — drugi znak po lewej (indeks 41)
MSG_LINE_CHAR_R0  = 9    ; Message Line — pierwszy znak po prawej (indeks 78)
MSG_LINE_CHAR_R1  = 7    ; Message Line — drugi znak po prawej (indeks 79)
