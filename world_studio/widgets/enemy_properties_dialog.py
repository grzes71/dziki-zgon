...
class EnemyPropertiesDialog(QDialog):
    def __init__(self, enemy_instance: EnemyInstance, enemy_defs: list, enemy_colors: list = None, parent=None):
        ...
        # Strategy (vertical/horizontal/random/chaotic/patrol/pacing/snake/homing)
        self.combo_strategy = QComboBox()
        self.combo_strategy.addItems(["vertical", "horizontal", "random", "chaotic", "patrol", "pacing", "snake", "homing"])
