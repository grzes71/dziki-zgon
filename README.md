...
Przed zmianami w kodzie należy przeczytać oraz postępować wg zasad umieszczonych w pliku `.cursorrules`.

Wiele detali technicznych jest także opisanych w pliku `AI_CONTEXT.md`.
