...
- **Info Line** (górna linia statusowa): zawiera zarezerwowane znaki ramki (indeksy 0–1), nazwę regionu (indeksy 2–21, max 20 B), Ekwipunek/Inventory `[........]` (indeksy 22–31, 10 B: `[` kod 59, 8 slotów po kodzie 14, `]` kod 61), spację odstępu (indeks 32), czas gry MM:SS (indeksy 33–37) oraz zarezerwowane znaki ramki (indeksy 38–39).
